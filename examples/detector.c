...
void validate_animal(char *cfgfile, char *weightfile)
{
    network net = parse_network_cfg(cfgfile);
    if(weightfile){
        load_weights(&net, weightfile);
    ...
    list *plist = get_paths("/home/eunseop/data/animalDB/buf/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
...
void run_detector(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "val_animal")) validate_animal(cfg, weights);
